...
export default function ArgumentTextarea({ changeArgument, argument }: ArgumenTextareaProps) {
  ...
  return (
    <textarea className="w-full sm:w-[75%] bg-transparent border-custom-primary border-2 border-primary focus:outline-none shadow-xl focus:ring-1 rounded-lg h-32 mt-3"
